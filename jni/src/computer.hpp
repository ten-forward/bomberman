...
namespace bestiary {
	...
	public:
		static ComputerPtr Create(const std::string &iName, const std::string &iSpriteName, const std::string &iAiScript, int iInputStateIdx, SDL_Renderer* iRenderer, bool* alive);
